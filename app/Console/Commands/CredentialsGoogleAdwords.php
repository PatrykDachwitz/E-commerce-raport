...
class CredentialsGoogleAdwords extends Command
{
    ...
    public function __construct()
    {
        ...
        $this->credentialsPath = config('api.pathGoogleAdwordsCredentials');
        $this->tokenPath = config('api.pathGoogleAdwordsToken');
    }

    protected $signature = 'google-auth:adwords';
     ...
     * @var string
     */
    protected $description = 'First token configuration and acceptance of Google resources for Google Ads API.';
