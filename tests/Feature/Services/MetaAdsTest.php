...
describe('Testing response meta ads services with correct data', function () {
    ...
    it("Testing correct structure response services", function () {
        /*$metaAds = new MetaAdsApi();

        expect($metaAds->get("2024-06-20", "2024-06-21"))
            ->toHaveKeys([
               'click' => [
                   'current',
                   "summaryWithoutCurrent",
                   "avgWithoutCurrent",
                   "avgComparisonWithoutCurrent",
                   "minWithoutCurrent",
                   "maxWithoutCurrent",
               ],
                "budget" => [
                    ...
                    "minWithoutCurrent",
                    "maxWithoutCurrent",
                    "spentBudgetFromBeginningOfMonth",
                    "budgetMonthly",
                    "percentSpentBudgetMonthlyCurrentDay",
                ]
            ]);*/
    });

    // Do weryfiakcji co jeśłi nie ma wynikow z fb respone api
